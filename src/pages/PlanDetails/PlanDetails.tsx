            ...
            <div className="pb-14 appearme">
                    ...
                    <div className="mt-2">
                        ...
                        <div className="text-xs mt-1 flex justify-between">
                            <span className="opacity-50">
                                {selectedProduct?.product_academy}
                            </span>
                            <span className="text-orange">
                                {selectedProduct?.enrolled_qty} +Enrolled
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div className="px-4">
                    <div className="flex">
                        <img
                            src={sessionImg}
                            alt="yoga"
                            className="w-6 -mt-2 mr-3"
                        />
                        <div className="text-xl font-bold mb-3">
                            Session Flow{" "}
                            {selectedProduct?.session_duration ? (
                    ...
                    <div className="relative ml-2 left-bar-wrapper">
                        {selectedProduct
                            ? selectedProduct.session_flow.map((item: any) => {
                                  return (
                                      <div
                                          className="pl-8 pb-2 left-bar relative"
                                          key={item.title}
                                      >
                ...
                <div className="px-4 list-disc">
                    ...
                    <ul className="list-outside list-disc">
                        {selectedProduct
                            ? selectedProduct.product_benefits.map(
                                  (item: string) => {
                                      return (
                                          <li
                                              className="ml-4 mt-2 opacity-50 text-15"
                                              key={item}
                                          >
                                              {item}
                                          </li>
                ...
                <div className="px-4 pb-8">
                    ...
                    <div className="flex mt-3">
                        ...
                        <span className="opacity-50">
                            On booking, you will be provided with details on
                            email.
                        </span>
                    </div>
                    <div className="flex mt-3">
                        ...
                        <span className="opacity-50">
                            Prior to the session, you will receive a link that
                            you need to connect via stable internet connection.
                        </span>
                    </div>
                </div>
                <button
                    className="text-15 z-10 outline-none focus:outline-none fixed bottom-0 w-full left-0 font-bold text-white bg-green text-center py-5"
